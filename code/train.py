...
from model import NGRF-SDMO
from morl_rl import MORLPPOTrainer, ObjectiveSpec
...
class EdgeSupervisionState:
    ...
    prediction matrix produced by NGRF-SDMO.
    """
...
print("seed=%d, evaluating metabolite-disease with NGRF-SDMO" % args.seed)
...
with open("../result/NGRF-SDMO.txt", mode="a+", encoding="utf-8") as file:
